<#
.SYNOPSIS
  macOS version: download all.zip attachment from Office 365 email, extract CSV, and generate the dated JSON.
.DESCRIPTION
  Mirrors download-report.ps1 (Windows) with identical logic so the produced JSON matches.
